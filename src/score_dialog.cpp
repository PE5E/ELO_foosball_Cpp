    ...
    wxDialog(NULL, -1, title, wxDefaultPosition, wxSize(700, 400)) 
{
    ...
    player_1_sizer->AddSpacer(10);
    wxStaticText *player_1_o_elo = new wxStaticText(panel_a, -1, wxString::Format(wxT("%.1f"), players.at(0).old_elo), wxPoint(0, 0), wxSize(50, 30), wxST_NO_AUTORESIZE);
    player_1_sizer->Add(player_1_o_elo, 0);
    player_1_sizer->AddSpacer(10);
    wxStaticText *player_1_elo_diff = new wxStaticText(panel_a, -1, wxString::Format(wxT("%.1f"), players.at(0).elo_diff), wxPoint(0, 0), wxSize(50, 30), wxST_NO_AUTORESIZE);
    player_1_sizer->Add(player_1_elo_diff, 0);
    player_1_sizer->AddSpacer(10);
    wxStaticText *player_1_n_elo = new wxStaticText(panel_a, -1, wxString::Format(wxT("%.1f"), players.at(0).new_elo), wxPoint(0, 0), wxSize(50, 30), wxST_NO_AUTORESIZE);
    ...
    if(teams_2v2)
    {
        ...
        player_3_sizer->AddSpacer(10);
        wxStaticText *player_3_o_elo = new wxStaticText(panel_a, -1, wxString::Format(wxT("%.1f"), players.at(2).old_elo), wxPoint(0, 0), wxSize(50, 30), wxST_NO_AUTORESIZE);
        player_3_sizer->Add(player_3_o_elo, 0);
        player_3_sizer->AddSpacer(10);
        wxStaticText *player_3_elo_diff = new wxStaticText(panel_a, -1, wxString::Format(wxT("%.1f"), players.at(2).elo_diff), wxPoint(0, 0), wxSize(50, 30), wxST_NO_AUTORESIZE);
        player_3_sizer->Add(player_3_elo_diff, 0);
        player_3_sizer->AddSpacer(10);
        wxStaticText *player_3_n_elo = new wxStaticText(panel_a, -1, wxString::Format(wxT("%.1f"), players.at(2).new_elo), wxPoint(0, 0), wxSize(50, 30), wxST_NO_AUTORESIZE);
    ...
    player_2_sizer->AddSpacer(10);
    wxStaticText *player_2_o_elo = new wxStaticText(panel_b, -1, wxString::Format(wxT("%.1f"), players.at(1).old_elo), wxPoint(0, 0), wxSize(50, 30), wxST_NO_AUTORESIZE);
    player_2_sizer->Add(player_2_o_elo, 0);
    player_2_sizer->AddSpacer(10);
    wxStaticText *player_2_elo_diff = new wxStaticText(panel_b, -1, wxString::Format(wxT("%.1f"), players.at(1).elo_diff), wxPoint(0, 0), wxSize(50, 30), wxST_NO_AUTORESIZE);
    player_2_sizer->Add(player_2_elo_diff, 0);
    player_2_sizer->AddSpacer(10);
    wxStaticText *player_2_n_elo = new wxStaticText(panel_b, -1, wxString::Format(wxT("%.1f"), players.at(1).new_elo), wxPoint(0, 0), wxSize(50, 30), wxST_NO_AUTORESIZE);
    ...
    if(teams_2v2)
    {
        ...
        player_4_sizer->AddSpacer(10);
        wxStaticText *player_4_o_elo = new wxStaticText(panel_b, -1, wxString::Format(wxT("%.1f"), players.at(3).old_elo), wxPoint(0, 0), wxSize(50, 30), wxST_NO_AUTORESIZE);
        player_4_sizer->Add(player_4_o_elo, 0);
        player_4_sizer->AddSpacer(10);
        wxStaticText *player_4_elo_diff = new wxStaticText(panel_b, -1, wxString::Format(wxT("%.1f"), players.at(3).elo_diff), wxPoint(0, 0), wxSize(50, 30), wxST_NO_AUTORESIZE);
        player_4_sizer->Add(player_4_elo_diff, 0);
        player_4_sizer->AddSpacer(10);
        wxStaticText *player_4_n_elo = new wxStaticText(panel_b, -1, wxString::Format(wxT("%.1f"), players.at(3).new_elo), wxPoint(0, 0), wxSize(50, 30), wxST_NO_AUTORESIZE);
